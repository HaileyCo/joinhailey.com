...
const Mobile = ({ screen }) => {
    ...
    return ( <
        ...
        lawyers and designers joined to explore and develop creative solutions to issues at the intersection of law and technology. <
        /Text.Paragraph> < /
        Layout.Row > <
        Spacer.Large grow / >
        <
        ...
        professions and age.You will join legal tech founders, software developers, engineers, lawyers, designers and illustrators,
        policy advocates, researchers, and a variety of users with passion
        for legal tech. <
        /Text.Paragraph> <
        Spacer.Medium / >
        <
        Text.Paragraph >
        Hailey leads the way within legal tech in embracing ideas with enthusiasm; in developing new products and services to be piloted and scaled, and in inspiring users to find solutions
        for tech innovation. <
        /Text.Paragraph> < /
        Layout.Column > <
        /Layout.Row> < /
        ...
        Layout.Row justifyCenter >
        <
        Icon.Idea / > { iphone_se ? < Spacer.Medium / > : < Spacer.Vertical.Medium / > } <
        ...
        Layout.Row justifyCenter >
        <
        Icon.Link / > { iphone_se ? < Spacer.Medium / > : < Spacer.Vertical.Medium / > } <
        Layout.Column width = "65%" >
        <
        ...
        Layout.Row justifyCenter >
        <
        Icon.Learn / > { iphone_se ? < Spacer.Medium / > : < Spacer.Vertical.Medium / > } <
        Layout.Column width = "65%" >
        <
        Text.H4 center = { iphone_se } > Learn < /Text.H4> <
        Text.Paragraph center = { iphone_se } >
        Find your next mentor and level up your Law, Design, and Tech knowledge <
        /Text.Paragraph> < /
        Layout.Column > <
        /Layout.Row> < /
        Layout.Row > <
        ...
        <
        Text.Paragraph >
        Your next cofounders and mentors are already here.Check out what they have to say:
        <
        /Text.Paragraph>
        ...
        diversity and inclusivity are key components of Hailey.Let the disruption begin!
        <
        /Text.Paragraph> <
        Spacer.Medium / >
        <
        ...
        <
        Text.Paragraph center italic >
        Linn and Malin, the Hailey founders, are great at not only seeing the future of legal, but bringing the community together at the grassroots to actually make it happen. <
        /Text.Paragraph> <
        Spacer.Medium / >
        <
        Text.Paragraph center >
        ...
        <
        Text.Paragraph center italic >
        The Hailey founders have a deep understanding
        for the crusially important intersection between tech and legal.They have an energy and drive that can move mountains and extensive networks in the field, laying a strong base
        for this community. <
        /Text.Paragraph> <
        Spacer.Medium / >
        <
        Text.Paragraph center >
        Lise Alm, Head of Business Development at the Arbitration Institute at the Stockholm Chamber of Commerce <
        /Text.Paragraph> < /
        Layout.Column >
        ...
        <
        Section.MediumMobile backgroundOpacity = { 0.90 } >
        <
        Layout.Column >
        <
        Text.H2 >
        ...
        <
        Text.Paragraph >
        Hailey was founded by a Stockhol - based team with the purpose of joining the tech community with the legal community, creating an interdisciplinary, innovative disruptive community. <
        /Text.Paragraph>
        ...
        Text.Paragraph center >
        Sign up
        for Hailey and find your next legal tech partner in crime!
        <
        /Text.Paragraph> < /
        Layout.Row >
